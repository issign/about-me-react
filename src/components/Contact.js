    ...
    >
      ...
      >
        ...
        >
          ...
          voluptate nesciunt fuga consequatur, itaque quibusdam facilis enim
          repellat quos dignissimos nostrum labore magnam veritatis? Eum tenetur
          perspiciatis ea neque?
        </motion.p>

        <button className="relative overflow-hidden group bg-gradient-to-r from-blue-600 via-sky-500 to-blue-400 px-8 py-4 md:text-lg rounded-full font-semibold transform transiton-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/25 text-white">
        ...
        <footer className="w-full mt-16 border-t border-gray-800/30 p-10">
          <div className="text-gray-400 text-center text-sm sm:text-base hover:text-gray-300 transition-colors">
            © 2025 Kiho Lee. All Rights Reserved
          </div>
        </footer>
      </motion.div>
    </div>
